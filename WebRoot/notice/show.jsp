  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">通知文件</th>
        <th align="center" valign="middle" class="borderright">发布日期</th>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">
           <a  href="<%=path%>/upload/${data[2]}" >${data[2] }</a>
        </td>
         <td align="center" valign="middle" class="borderright borderbottom">
              <fmt:formatDate value="${data[3] }"  pattern="yyyy-MM-dd"/>
         </td>
        <c:if test="${role eq '管理员' }">
        <td align="center" valign="middle" class="borderbottom">
           <a href="<%=path %>/noticeServlet?operate=modify&id=${data[0] }" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span>
           <a href="<%=path %>/noticeServlet?operate=del&id=${data[0] }" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
        </td>
        </c:if>
      </tr>
      </c:forEach>
