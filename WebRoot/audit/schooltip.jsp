    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderbottom">
          <c:if test="${data[6] eq '学校通过'}">
           <a href="<%=path %>/auditServlet?operate=schoolTipyes&id=${data[0]}" target="mainFrame" onFocus="this.blur()" class="add">通过</a><span class="gray">&nbsp;|&nbsp;</span>
           <a href="<%=path %>/auditServlet?operate=schoolTipno&id=${data[0]}" target="mainFrame" onFocus="this.blur()" class="add">未通过</a>
           </c:if>
