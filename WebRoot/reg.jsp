...
<script>
  function reg(){
      ...
      if(role=="1"){
          window.location.href="<%=path%>/reg/stu.jsp";
      }else if(role=="2"){
          window.location.href="<%=path%>/reg/teacher.jsp";
      }else if(role=="3"){
          window.location.href="<%=path%>/reg/admin.jsp";
      }else{
           alert("请选择角色!");
      }
  }
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">选择角色：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="role" id="role"  onchange="reg();">
        <option>请选择</option>
